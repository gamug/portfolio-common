...
10. **Once a Work Item is finished, move the entire work item to
    ...
    the one sanctioned exception to "the same change that closes it". Not
    to be confused with the repo-root `CHANGELOG.md` (Code & Git #5), the
    package's release/compatibility record for consumers.
