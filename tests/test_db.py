"""Tests for portfolio_common/db.py -- the one connection factory shared by
...
from portfolio_common.db import BUSY_TIMEOUT_MS, DEFAULT_DB_PATH, connect, resolve_db_path
