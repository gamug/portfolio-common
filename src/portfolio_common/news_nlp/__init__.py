"""The news-NLP results-DB layer, shared with ``portfolio-nlp``.
...
``portfolio-nlp`` imports this as its ``db`` module. See
``portfolio-common/docs/news-nlp-db-topology.md``.
"""

from __future__ import annotations

from portfolio_common.news_nlp.corrections import (
    delete_category,
...
from portfolio_common.news_nlp.db import (
    attach_source,
    connect,
    connect_pipeline,
    detach_source,
...
from portfolio_common.news_nlp.env import (
    RESULTS_DB_ENV_VAR,
    SOURCE_DB_ENV_VAR,
    results_db_path,
    source_db_path,
)
from portfolio_common.news_nlp.queries import (
...
from portfolio_common.news_nlp.schema import (
    SCHEMA,
    SECTOR_SUMMARY_FORMAT_VERSION,
    init_schema,
)
from portfolio_common.news_nlp.sector_summary import (
    build_sector_facts,
...
from portfolio_common.news_nlp.taxonomy import (
    CATEGORY_LABELS,
    CATEGORY_SLUGS,
    OTHER_LABEL,
)
