...
recreated on every :func:`portfolio_common.kg_schema.ensure` call -- they are cheap and always current.
...
def ensure_views(conn: sqlite3.Connection) -> None:
    ...
    ``ALTER TABLE ... RENAME`` in :mod:`portfolio_common.kg_schema.migrations` performs.
    """
